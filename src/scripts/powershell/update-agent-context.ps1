...
$TEMPLATE_FILE = Join-Path $REPO_ROOT '.buildforce/templates/agent-file-template.md'
...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Run buildforce init to scaffold .buildforce/templates, or add agent-file-template.md there.'
        exit 1
    }
}
